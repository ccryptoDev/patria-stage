...
module.exports = function (req, res, next) {
 ...
 req.file('proofdocument').upload(imageUploadConfig.tempConfig, function (err, uploadedFiles) {
    if (err) {
      sails.log.error('@UploadTempproofdocument :: Document Uploading Error :: ', err);
